    ...
    <div class="product-container row">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-2">
                ...
                <span class="badge-diskon"><?= htmlspecialchars($produk['diskon']); ?>% OFF</span>
            </div>
            <div class="mb-3 price-discount">
                Rp <?= number_format($produk['harga_setelah_diskon'], 0, ',', '.'); ?>
            </div>
            <div class="button mt-5 d-grid gap-2">

                <a href="edit.php?id=<?= $produk['id']; ?>" class="btn btn-success">Edit Produk</a>
                <a href="dashboard.php" class="btn btn-outline-secondary"> Kembali ke Katalog</a>
